...
#ifdef RB_FRLS
	void GrepRecursive(GrepFlags gf, const FilePath &baseDir, const char* searchString, const GUI::gui_char* fileTypes, unsigned int basePath); //!-change-[FindResultListStyle]
#else
