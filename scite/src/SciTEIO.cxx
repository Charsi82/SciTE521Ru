...
#ifdef RB_FRLS
void SciTEBase::GrepRecursive(GrepFlags gf, const FilePath &baseDir, const char* searchString, const GUI::gui_char* fileTypes, unsigned int basePath) { //!-change-[FindResultListStyle]
#else
