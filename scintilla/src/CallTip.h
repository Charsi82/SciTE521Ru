...
class CallTip {
	...
	SplitVector<size_t> startHighlight;    // character offset to start and...
	SplitVector<size_t> endHighlight;      // ...end of highlighted text
//!-end-[BetterCalltips]
#else
...
#ifdef RB_BTCT
	void WrapLine(const char* text, size_t offset, size_t length, SplitVector<size_t>& wrapPosList); //!-add-[BetterCalltips]
#endif // RB_BTCT
...
public:
	...
	void AddHighlight(size_t start, size_t end);
